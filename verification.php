...
foreach ($users as $user){
    ...
    {
    echo "Vous avez accès à la partie administration";
    header('Location: index.php');
    }
    else {
        echo "La combinaison login et mot de passe est incorrecte !"; ?>
        <br/><br/>
        <a href="login.php">Cliquez ici pour retourner sur la page de login !</a>
    <? }
}
?>
